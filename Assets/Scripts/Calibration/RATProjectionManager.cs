...
namespace FlexIO {
    ...
    public class RATProjectionManager : MonoBehaviour {
       ...
       //EDIT public List<RATUserViewCamera> userViewCameras = new List<RATUserViewCamera>();
        public List<RATProjector> projections = new List<RATProjector>();
        //EDIT public List<RATDepthMesh> depthMeshes = new List<RATDepthMesh>();
        ...
        */
        ...
        void OnValidate()
        {
             //EDIT    FindProjectionsDepthMeshesAndUsers();
        }
        void Awake()
        {
