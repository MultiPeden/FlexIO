...
namespace FlexIO
{
    ...
    /// </summary>
    public class RATKinectClient : MonoBehaviour
    {
        /// <summary>
        ...
        */
        ...
        public void UpdateFromCalibrationData()
        {
            ...
            else
            {
                ...
                FlexIO.Matrix p = new Matrix(4, 4);
                p.Identity();
                SetPose(p);
        ...
        public void SetPose(FlexIO.Matrix pose)
        {
    ...
    */
        ...
        public  Vector3 KinectToWorld(Vector3 pos)
        {
